...
parser.add_argument('--model_type',      type=str, choices=['snn', 'amil', 'mcat', 'motcat','motcat_text','motcat_text_only',
                                                            'icunet', 'icunet_wocap', 'icunet_wodiag', 'motmamba_text',
                                                            'icunetv2',
                                                            'icunetv3'], 
...
parser.add_argument('--bag_loss',        type=str, choices=['svm', 'ce', 'ce_surv', 'nll_surv',
                                                            ...
                                                            'dense_combine', 'dense_balanced_combine'],
...
if args.model_type.lower() in ['motcat','motmamba_text']:
    ...
    if 'uot' in args.ot_impl:
        ...
        raise NotImplementedError
elif args.model_type.lower() in ['icunet', 'icunet_wocap', 'icunet_wodiag','icunetv2', 'icunetv3']:
