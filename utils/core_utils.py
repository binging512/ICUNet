...
def train(datasets: tuple, cur: int, args: Namespace):
    ...
    if args.model_type =='snn':
        ...
        from models.model_icunet import ICUNet
        model_dict = {'ot_reg': args.ot_reg, 'ot_tau': args.ot_tau, 'ot_impl': args.ot_impl,'fusion': args.fusion, 'omic_sizes': args.omic_sizes, 'n_classes': args.n_classes}
        model = ICUNet(**model_dict)
    else:
        raise NotImplementedError
    ...
    for epoch in range(args.start_epoch,args.max_epochs):
        if args.mode == 'coattn':
            ...
            if args.model_type in ['motcat_text', 'motcat_text_only', 'motmamba_text']:
            ...
            elif args.model_type in ['icunet', 'icunet_wocap', 'icunet_wodiag', 'icunetv2', 'icunetv3']:
                from trainer.icu_trainer import train_loop_survival_icu, validate_survival_icu
                train_loop_survival_icu(epoch, args.bs_micro, model, train_loader, optimizer, scheduler, args.n_classes, writer, loss_fn_dict, reg_fn, args.lambda_reg, args.gc, args)
                val_latest, c_index_val, stop = validate_survival_icu(cur, epoch, args.bs_micro, model, val_loader, args.n_classes, early_stopping, monitor_cindex, writer, loss_fn_dict, reg_fn, args.lambda_reg, args.results_dir, args)
